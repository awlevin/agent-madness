      ...
      <div className="space-y-2">
        {brackets.map((bracket, i) => (
          <Link
            ...
            className="group flex items-center gap-3 px-4 py-3 border border-white/5 bg-bg-dark/60 hover:border-court-orange/30 hover:bg-bg-dark/80 transition-all duration-300"
          ...
          >
            ...
            <span className="text-text-secondary/30 text-xs shrink-0">
              /
            </span>

            {bracket.champion ? (
              <span className="flex items-center gap-1.5 shrink-0">
                <span className="font-[family-name:var(--font-pixel)] text-[8px] sm:text-[9px] text-text-secondary/50">
                  CHAMP:
                </span>
                <span className="font-[family-name:var(--font-pixel)] text-[9px] sm:text-[10px] text-arcade-yellow">
            ...
            <span className="ml-auto font-[family-name:var(--font-pixel)] text-[7px] sm:text-[8px] text-text-secondary/40 shrink-0">
